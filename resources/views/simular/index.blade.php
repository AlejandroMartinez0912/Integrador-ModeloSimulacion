        ...
        <form action="{{ route('simular.simular') }}" method="POST">
           ...
           <div class="row"> 
                <div class="col-md-6 mb-3"> <!-- Fila 1, Columna 1 -->
                    ...
                    <input type="string" class="form-control" id="producto" name="producto" required  placeholder="Ingrese el nombre del producto">
                </div>
                <div class="col-md-6 mb-3"> <!-- Fila 1, Columna 2 -->
                    <label for="cantidad" class="form-label">Cantidad inicial</label>
                    <input type="number" class="form-control" id="cantidad" name="cantidad_inicial" required placeholder="Ingrese la cantidad inicial de stock">
                </div>
            </div>
            
           <div class="row"> <!-- El 'row' es esencial para el sistema de cuadrícula -->
                <div class="col-md-6 mb-3"> <!-- Una columna para el select, ocupando la mitad del ancho en md y superior -->
                    <label for="semilla" class="form-label">Seleccione la semilla</label>
                    <select class="form-select" id="semilla" name="semilla" required placeholder="Seleccione la semilla a simular">
